...
function smarty_compiler_widget($arrParams,  $smarty){
    ...
    if($strName){
        ...
        if($bHasCall){
            $strCode .= '$_smarty_tpl->_subTemplateRender($_tpl_path, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, $_smarty_tpl->caching, $_smarty_tpl->cache_lifetime, ' . $strFuncParams . ', Smarty::SCOPE_LOCAL,false,null,null);';
            $strCode .= 'if(is_callable('. $strTplFuncName . ')){';
            $strCode .= $strCallTplFunc;
            $strCode .= '}else{';
            ...
            $strCode .= 'echo $_smarty_tpl->_subTemplateRender($_tpl_path, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, $_smarty_tpl->caching, $_smarty_tpl->cache_lifetime, ' . $strFuncParams . ', Smarty::SCOPE_LOCAL,false,null,null);';
        }
        $strCode .= '}else{';
...
function getWidgetStrCode($path, $arrParams){
    ...
    $strCode .= '}else{';
    $strCode .=     '$fis_widget_output = $_smarty_tpl->_subTemplateRender("' . $path . '", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, '. $strFuncParams.', Smarty::SCOPE_LOCAL,false,null,null);';
    $strCode .=     'if(is_callable(' . $fn .')){';
    $strCode .=         'return call_user_func('. $fn . ',$_smarty_tpl,' . $strFuncParams . ');';
    $strCode .=     '}else{';
